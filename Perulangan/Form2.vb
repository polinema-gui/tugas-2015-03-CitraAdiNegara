    ...
    Private Sub btn_proses_Click(sender As Object, e As EventArgs) Handles btn_proses.Click
        Try
            Select Case Cmb_pola.Text
                Case "Pyramid"
                    pyramid(Convert.ToInt32(Tbl_baris.Text))
                Case "Hollow Pyramid"
                    hollowPyramid(Convert.ToInt32(Tbl_baris.Text))
                Case "Inverted Pyramid"
                    invertedPyramid(Convert.ToInt32(Tbl_baris.Text))
                Case "Hollow Inverted Pyramid"
                    hollowInvertedPyramid(Convert.ToInt32(Tbl_baris.Text))
                Case Else
                    tbl_hasil.Text = "Anda Belum Memilih Pola"
            End Select
        Catch ex As Exception
            tbl_hasil.Text = "Masukan Bukan Angka"
        End Try
    End Sub
